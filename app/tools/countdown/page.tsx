...
const CountdownTimer = () => {
    ...
    return (
        <div className="p-6 flex flex-col gap-1 w-full items-center justify-center">
            ...
            <div className="text-xl font-semibold w-32 p-4 text-center bg-secondary rounded-lg mb-10">{time}s</div>
            ...
            <div className="flex gap-2 mt-1">
                ...
                <Button onClick={resetTimer} className='bg-destructive hover:bg-destructive/80'>
                    Reset
                </Button>
            </div>
        </div>
