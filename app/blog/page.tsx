  ...
  return (
    <div className="flex bg-zinc-300 dark:bg-zinc-800 rounded-2xl">
      <div className="hidden lg:flex text-zinc-600 dark:text-zinc-400 flex-col gap-5 w-[20%] my-8 p-4 sticky top-0 h-fit">
        <div>
          <h3 className="text-xl mb-2 text-zinc-800 dark:text-white">
            Latest Posts
          </h3>
        ...
        <div className=" flex gap-2 flex-wrap">
          <h3 className="text-xl mb-2 text-zinc-800 dark:text-white w-full">
            Categories
          </h3>
          <HoverBorderGradient className="bg-zinc-800 py-1 px-4 inline">
      ...
      <div className="w-full lg:w-[80%] m-8 bg-black/20 rounded-lg p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
        ...
        <CardDemo
          src="/products/2.jpg"
          href="#"
          title="Should I become a developer in 2030"
        />
        <CardDemo
          src="/products/3.jpg"
          href="#"
          title="What is happening to the world!?"
        />
