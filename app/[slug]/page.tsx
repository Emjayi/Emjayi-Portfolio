...
export default function Page() {
	...
	return (
		<div className="flex flex-col justify-center h-[100dvh] w-screen items-center text-6xl gap-5 overflow-y-hidden">
			{project?.title}
			<Link href={nextproject.link} className="text-xl border rounded-md px-6 py-2">{nextproject.title}</Link>
			<Link href="/" className="text-xl border rounded-md px-6 py-2">Home</Link>
		</div>
	);
}
