...
export const Card: React.FC<PropsWithChildren> = ({ children }) => {
	...
	return (
		<div
			...
			className="overflow-hidden relative border rounded-xl group md:gap-8 backdrop-blur-sm border-zinc-600 bg-zinc-400/30 dark:border-zinc-500/10 dark:bg-zinc-900/30"
		>
